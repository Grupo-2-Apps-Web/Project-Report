...
<table>
  ...
  <td><strong>TF</strong></td>
      ...
      <td>
        Se han incluído los siguientes cambios:
        <ul>
          <li>Implementación de mejoras: Actualización del diseño de la base de datos con las tablas actualizadas, se mejoró el video About-The-Product, mejora del Backend con nuevos endpoints y IAM incluido y actualización del Frontend para su correcto funcionamiento con el Backend.</li>
